...
export function SearchBar({ storeName, departments, actionPath = '/s', defaultQuery, defaultDept = '' }: SearchBarProps) {
  return (
    <form action={actionPath} method="get" role="search" className="flex h-[40px] min-w-0 flex-1 overflow-hidden rounded-[8px] bg-white focus-within:ring-[3px] focus-within:ring-[rgb(255_153_0_/_0.65)]">
